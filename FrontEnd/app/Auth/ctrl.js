app.controller("LoginController", ['$scope', '$state', 'userdata', 'md5', '$http', 'appSettings', 'Base64', '$localStorage',
    function($scope, $state, userdata, md5, $http, appSettings, Base64, $localStorage) {
